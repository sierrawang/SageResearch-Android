...
public abstract class IndividualNavigatorTests {
    ...
    public void testProgress_MarkersAndSections_Introduction() {
        ...
        Progress progress = navigator.getProgress(steps.get(0), taskResult);
        assertNull(progress);
    }
    ...
    public void testProgress_MarkersAndSections_Step2() {
        ...
        Task.Progress progress = navigator.getProgress(step, taskResult);
    ...
    public void testProgress_MarkersAndSections_Step7() {
        ...
        Task.Progress progress = navigator.getProgress(steps.get(7), taskResult);
        assertNotNull(progress);
    ...
    public void testProgress_MarkersAndSections_Step4B() {
        ...
        TaskResult taskResult = mockTaskResultFromResults("task", stepHistory);
        Task.Progress progress = navigator.getProgress(step4.getSteps().get(1), taskResult);
        assertNotNull(progress);
    ...
    public void testProgress_MarkersAndSections_Step5X() {
        ...
        TaskResult taskResult = mockTaskResultFromResults("task", stepHistory);
        Task.Progress progress = navigator.getProgress(step5.getSteps().get(0), taskResult);
        assertNotNull(progress);
    ...
    public void testProgress_MarkersAndSections_Step6C() {
        ...
        TaskResult taskResult = mockTaskResultFromResults("task", stepHistory);
        Task.Progress progress = navigator.getProgress(step6.getSteps().get(2), taskResult);
        assertNotNull(progress);
